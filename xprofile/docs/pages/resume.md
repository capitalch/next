...
#### Sushant can be contacted for full stack software development
| | |
| :---  |   :---   |
...
|               | Server side: <span class='highlight'>Node.js</span>, J2EE, Java, C#, ASP.NET, <a target='_blank' href='https://www.apollographql.com'>Apollo GraphQL Server</a>|
|               | Databases: <span class='highlight'>PostgreSql</span>, <a target='_blank' href='https://www.mysql.com'>MySQL</a>, <a target='_blank' href='https://www.oracle.com/database'>Oracle</a>, <a target='_blank' href='https://www.mongodb.com/'>Mongo DB</a>, <a target='_blank' href='https://www.microsoft.com/en-us/sql-server/, <a target='_blank' href='https://www.sap.com/india/products/sql-anywhere.html'>Sql Anywhere</a>, <a target='_blank' href='https://www.rethinkdb.com/'>ReThinkDb</a> |
|               | Mobile: <span class='highlight'><a target='_blank' href='https://flutter.dev'>Google Flutter</a></span>, <a target='_blank' href='https://dart.dev/'>Dart</a>, <a target='_blank' href='https://cordova.apache.org/'>Cordova</a>, <a target='_blank' href='https://ionicframework.com/'>Ionic</a>, <a target='_blank' href='https://facebook.github.io/react-native/'>React natiive</a> |
|               | Cloud: <a target='_blank' href='https://azure.microsoft.com'>Azure</a>, <a target='_blank' href='https://www.docker.com/'>Docker</a>, <a target='_blank' href='https://zeit.co/now'>Zeit Now</a>, Serverless deployments |
|               | Others: <a target='_blank' href='https://graphql.org/'>GrapgQL</a> , <a target='_blank' href='https://www.apollographql.com/'>Apollo Framework</a>, <a target='_blank' href='https://d3js.org/'>d3.js</a>, <a target='_blank' href='https://socket.io/'>socket.io</a>, SharePoint, WPF, WCF, REST, <a target='_blank' href='https://www.liferay.com/'>Liferay</a>, Crystal reports, <a target='_blank' href='https://www.jaspersoft.com/reporting-software'>Jasper Reports</a>, <a target='_blank' href='https://www.office.com/'>Office 365</a> |
...
#### July 2019:
Individual contributor. Done a POC on Elastic Search. Implemented elastic search on cloud.

#### Feb 2018 - June 2019: 
Part time CTO (Chief Technology Officer) in a multinational company. Worked on React.js, Gatsby, Next.js, PostgreSql, Node.js, GraphQL, Flutter, Dart, Angular 6, Docker
...
#### Oct 2017 - Jan 2018:
Full time CTO (Chief Technology Officer) in a multinational company. Worked mainly on Angular 4 / 5, D3.js, node.js and PostgreSql as chief architect and lead developer in a team
...
#### May 2015 – Sep 2017:
Chief architect and lead developer. Worked on Backbone, .net, Sql Server, Angular 2/ 4
...
#### April 2014 – May 2015:
Lead architect and developer. Worked on LifeRay Document Management system, Jasper reports, Java and Lucene

1) The application allows user to select reports from a drop-down list and fire it. This allows user defined custom parameters for the reports and makes use of Quartz Cron scheduler, various Apache libraries and Jasper Report framework extensively used. The technologies used were Liferay 6.1, Jasper Reports, Java 1.7, Apache libraries, Quartz Cron scheduler. The application was deployed in Linux Centos
...
#### June 2013 – Mar 2014:
Worked on Pivot reports, ETL, .net, Sql server, SSIS, SSRS, SharePoint client object model, Html
...
#### Jan 2013 – May 2013:
Worked as Senior Developer and Lead role in SSIS, Sql server, ETL scripts, C#
...
#### May 2012 – Dec 2012:
Worked as senior developer in Oracle database and Crystal reports for a US based company
...
#### Year 2010 – 2013: 
Worked in parallel to other projects as Lead developer and project manager in Windows forms, WPF, WCF,c#, ASP.net, Dev-express
...
#### Sep 2010 – April 2012:
Worked as Lead developer, architect in SharePoint 2007, c#, ASP.net, InfoPath
...
#### Mar 2008 – Sep 2009:
Worked as lead developer in SharePoint 2007, c#, Asp.net
...
#### Jan 2006 – Feb 2008:
Worked as Senior developer, QA, Technical writer in K2 workflow, ASP.net, c#
...
#### Before Jan 2006:
Worked as Freelancer mainly in Java, Powerbuilder and Sql Anywhere
